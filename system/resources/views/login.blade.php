...
<head>
	<title>Florist.Dy</title>
	<link rel="icon" type="image/x-icon" href="{{ url('public') }}/Logo.jpg" />
	<meta charset="utf-8">
...
<body class="img js-fullheight" style="background-image: url(public/login/images/Logiin.jpg);">
	<section class="ftco-section">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Floral.ID</h2>
				</div>
			</div>
			<div class="row justify-content-center">
